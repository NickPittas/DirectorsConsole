...
TARGET_MODELS: List[Dict[str, str]] = [
    ...
    {"id": "krea_2_large", "name": "Krea 2 Large", "category": "Image"},
    {"id": "krea_2_turbo", "name": "Krea 2 Turbo", "category": "Image"},
    {"id": "flux_2_max", "name": "FLUX.2 Max", "category": "Image"},
    {"id": "flux_2_pro", "name": "FLUX.2 Pro", "category": "Image"},
    {"id": "flux_2_flex", "name": "FLUX.2 Flex", "category": "Image"},
    {"id": "flux_2_klein", "name": "FLUX.2 Klein", "category": "Image"},
    {"id": "flux_2_dev", "name": "FLUX.2 Dev", "category": "Image"},
    {"id": "dall-e_3", "name": "DALL-E 3", "category": "Image"},
    {"id": "gpt_image_2.5_sunburst", "name": "GPT Image 2.5 Sunburst", "category": "Image"},
    {"id": "gpt_image_2.5_flare", "name": "GPT Image 2.5 Flare", "category": "Image"},
    ...
    {"id": "nano_banana_2", "name": "Nano Banana 2", "category": "Image"},
    {"id": "nano_banana_pro", "name": "Nano Banana Pro", "category": "Image"},
    {"id": "nano_banana_2_lite", "name": "Nano Banana 2 Lite", "category": "Image"},
    {"id": "seedream_5.0_pro", "name": "Seedream 5.0 Pro", "category": "Image"},
    {"id": "seedream_5.0_lite", "name": "Seedream 5.0 Lite", "category": "Image"},
...
MODEL_ID_ALIASES: dict[str, str] = {
    "flux": "flux.1",
    "krea-2-large": "krea_2_large",
    "krea-2-turbo": "krea_2_turbo",
    "flux-2-max": "flux_2_max",
    "flux-2-pro": "flux_2_pro",
    "flux-2-flex": "flux_2_flex",
    "flux-2-klein": "flux_2_klein",
    "flux-2-dev": "flux_2_dev",
    "gpt-image-2.5-sunburst": "gpt_image_2.5_sunburst",
    "gpt-image-2.5-flare": "gpt_image_2.5_flare",
    ...
    "seedream-5.0-lite": "seedream_5.0_lite",
    "wan2.1": "wan_2.1",
    "wan2.2": "wan_2.2",
    "runway": "runway_gen-4",
    "pika": "pika_2.0",
