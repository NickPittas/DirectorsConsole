...
- Recovery runs before the Cinema, Storyboard, or Gallery components mount. It restores the active app tab, project identity, Storyboard work state, panel history/layout/parameters, and the CPE configurations/prompt/preset selections.
...
- Corrupt, unsupported, or unreadable snapshots are not deleted automatically. The recovery screen offers Retry, explicit Discard, or confirmed Start new.
